\documentclass[usletter,11pt,english,oneside,onecolumn,final,openany]{article}
...
\large Draft v0.0.4\footnote{This is just a draft, so it may not always be available wherever it is currently hosted.}\vspace{-.715cm}}
...
\date{\vspace{-.5cm}\today\vspace{-1.5cm}}
