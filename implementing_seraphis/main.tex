...
\hypersetup{
    pdftitle = {Implementing Seraphis}
}


\title{Implementing Seraphis (WIP)\footnote{\textbf{License}: public domain.}\\\vspace{.3cm}
\large Draft v0.0.3\footnote{This is just a draft, so it may not always be available wherever it is currently hosted.}\vspace{-.715cm}}
\author{koe\\
\texttt{ ukoe@protonmail.com}
\and
jeffro256\\
\texttt{ jeffro256@tutanota.com}}
\date{\vspace{-.35cm}\today\vspace{-1cm}}
